...
angular.module('investigationsApp.graphs', [])
        .factory("Graph", ['$rootScope', '$log', function ($rootScope, $log) {
          ...
          Graph.prototype.addLegend = function () {
            ...
            title.append("tspan").text("TeamCity").attr("x", "0");
            title.append("tspan").text("Investigations").attr("x", "0").attr("y", "32");

            //var titleHeight = parseInt(legendPlate.select('text').style('height'));
            var titleHeight = 64;
            var lh = 30;
            var lhp = 5;
            ...
            var legend = legendPlate.selectAll(".legendPlate")
                    ...
                    .attr("transform", function (d, i) {
                      return "translate(" + (xp) + "," + (1.5 * yp + titleHeight + i * lh) + ")";
                    });
